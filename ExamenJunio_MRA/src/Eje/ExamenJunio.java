            ...
            switch (opcion) {
                ...
                case 3:
                    switch (Entrada.leerEntero("\nBuscar por:\n 1.- NRP\n 2.- Telefono\n¿?")) {
                        case 1:
                            empleado = instituto.buscarEmpleadoNrp(Entrada.leerCadena("NRP"));
                            break;
                        case 2:
                            empleado = instituto.buscarEmpleadoTlf(Entrada.leerEntero("Teléfono"));
                            break;
                        default:
                            empleado = null;
                    }
